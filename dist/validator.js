...
exports.default = {
  // 整数
  intNum: function intNum(value) {
    var isInt = /^[0-9]*$/;
    return isInt.test(value);
  },
  // 三位正小数，用于重量
  weightNum: function weightNum(value) {
    var isWeight = /^\d+(\.\d{1,3})?$/;
    return isWeight.test(value);
  },
  // 只允许至多两位小数的数字，一般用于单价和金额
  priceNum: function priceNum(value) {
  ...
  phone: function phone(value) {
    ...
    var isMobile = /^((1[3-9]{1}[0-9]{1})+\d{8})$/; // 增加了16+ 和 19+ 网段
  ...
  idCard: function idCard(value) {
    var isIdCard = /(^[1-9]\d{5}(18|19|([23]\d))\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]$)|(^[1-9]\d{5}\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{2}[0-9Xx]$)/;
    return isIdCard.test(value);
  },
  // 确认密码，需传两个参数
  confirmPassword: function confirmPassword(psw, confirmPsw) {
